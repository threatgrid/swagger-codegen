...
public class ClojurescriptClientCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    public ClojurescriptClientCodegen() {
        super();
        outputFolder = "generated-code" + File.separator + "clojurescript";
        apiTemplateFiles.put("api.mustache", ".cljc");
        embeddedTemplateDir = templateDir = "clojurescript";

        cliOptions.add(new CliOption(PROJECT_NAME,
                "name of the project (Default: generated from info.title or \"swagger-cljs-client\")"));
    ...
    public String getHelp() {
        return "Generates a Clojurescript client library.";
    }
    ...
    public void preprocessSwagger(Swagger swagger) {
        ...
        // default values
        if (projectName == null) {
            projectName = "swagger-cljs-client";
        }
        if (projectVersion == null) {
        ...
        supportingFiles.add(new SupportingFile("core.mustache", baseNamespaceFolder, "core.cljc"));
